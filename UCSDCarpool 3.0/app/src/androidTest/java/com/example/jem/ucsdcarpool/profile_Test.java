...
//        onView(withId(R.id.user_gender_update_custom)).check(matches(withText("fj@fj.com")));
//        onView(withId(R.id.user_ssn_update_custom)).check(matches(withText("fj@fj.com")));
//        onView(withId(R.id.user_address_update_custom)).check(matches(withText("fj@fj.com")));
//        onView(withId(R.id.user_phone_update_custom)).check(matches(withText("fj@fj.com")));
//        onView(withId(R.id.user_zipcode_update_custom)).check(matches(withText("fj@fj.com")));
        ...
        //button save
//        onView(withId(R.id.Basic_save)).perform(click());
//        //checksave
//        onView(withId(R.id.user_name_update_custom)).check(matches(withText("fjfjfj")));
//        onView(withId(R.id.user_ID_update_custom)).check(matches(withText("fj")));
//        onView(withId(R.id.user_email_update_custom)).check(matches(withText("fj@fj.com")));
